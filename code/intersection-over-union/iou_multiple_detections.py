...
# GT1 = np.matrix([[0, 10, 200, 110],[95,40,200,180]])
...
for detection in examples:
	...
	# iou1 is a vector of iou scores for each detection with ground truth1 and similarly iou2 a vector wrt ground truth2
	iou = []
	for i in range(0,len(prediction)):
		iou[0,i] = bb_intersection_over_union(detection.gt1, prediction[i])
		iou[1,i] = bb_intersection_over_union(detection.gt2, prediction[i])
