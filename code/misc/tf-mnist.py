...
# At this stage the dimensions is 4 x 4 x 8

#Decoder

# 3rd Deconv layer (reverse of the third conv layer)
  with tf.name_scope('deconv3'):
  	W_deconv3 = weight_variable([3,3,8,8])  
  	b_deconv3 = bias_variable([8])
  	h_deconv3 = tf.nn.relu(deconv2d(h_pool3, W_deconv3)+ b_deconv3)

# 3rd upsample layer
  with 

# 2nd deconv layer (reverse of the 2nd conv layer)
  with tf.name_scope('deconv3'):
  	W_deconv3 = weight_variable([3,3,8,8])  
  	b_deconv3 = bias_variable([8])
  	h_deconv3 = tf.nn.relu(conv2d(h_pool3, W_deconv3)+ b_deconv3)
