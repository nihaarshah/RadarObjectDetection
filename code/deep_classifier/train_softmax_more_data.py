...
# Add a dense logistic regressor on top of the reshaped layer
...
classifier.compile(optimizer='adadelta',loss = 'binary_cross_entropy', metrics=['accuracy'])
...
classifier.save('/Users/nihaar/Documents/4yp/data/weights/08-01-18/softmax_model.h5')
